...
export const pricingData = {
  fixedRoutes: [
    { vehicle: 'Sedan (Dzire)', route: 'Agra -> Delhi', fare: '₹3,199' },
    { vehicle: 'Sedan (Dzire)', route: 'Delhi -> Agra', fare: '₹2,899' },
    { vehicle: 'Sedan (Dzire)', route: 'Agra -> Ghaziabad', fare: '₹3,199' },
    { vehicle: 'Sedan (Dzire)', route: 'Ghaziabad -> Agra', fare: '₹2,899' },
    { vehicle: 'Sedan (Dzire)', route: 'Agra -> Noida', fare: '₹3,199' },
    { vehicle: 'Sedan (Dzire)', route: 'Noida -> Agra', fare: '₹2,899' },
    { vehicle: 'Sedan (Dzire)', route: 'Agra -> Gurgaon', fare: '₹3,199' },
    { vehicle: 'Sedan (Dzire)', route: 'Gurgaon -> Agra', fare: '₹2,899' },
    { vehicle: 'Sedan (Dzire)', route: 'Agra -> Faridabad', fare: '₹3,199' },
    { vehicle: 'Sedan (Dzire)', route: 'Faridabad -> Agra', fare: '₹2,899' },
    ...
    { vehicle: 'Ertiga / Rumion', route: 'Agra -> Delhi', fare: '₹4,299' },
    { vehicle: 'Ertiga / Rumion', route: 'Delhi -> Agra', fare: '₹3,599' },
    { vehicle: 'Ertiga / Rumion', route: 'Agra -> Ghaziabad', fare: '₹4,299' },
    { vehicle: 'Ertiga / Rumion', route: 'Ghaziabad -> Agra', fare: '₹3,599' },
    { vehicle: 'Ertiga / Rumion', route: 'Agra -> Noida', fare: '₹4,299' },
    { vehicle: 'Ertiga / Rumion', route: 'Noida -> Agra', fare: '₹3,599' },
    { vehicle: 'Ertiga / Rumion', route: 'Agra -> Gurgaon', fare: '₹4,299' },
    { vehicle: 'Ertiga / Rumion', route: 'Gurgaon -> Agra', fare: '₹3,599' },
    { vehicle: 'Ertiga / Rumion', route: 'Agra -> Faridabad', fare: '₹4,299' },
